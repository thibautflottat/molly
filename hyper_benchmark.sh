...
hyperfine --shell=none --warmup 2 "target/release/examples/reader $trajectory" "target/release/examples/xdrreader $trajectory" "target/release/examples/cfreader $trajectory"
